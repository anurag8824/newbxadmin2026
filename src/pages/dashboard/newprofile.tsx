...
import { selectBalance } from "../../redux/actions/balance/balanceSlice";

const Newprofile = () => {
  const userState = useAppSelector<{ user: User }>(selectUserData);

  const balance = useAppSelector(selectBalance);
  console.log(userState, balance, "user");
    ...
    <>
      <div>
        <div className={`profile-page`} style={{ overflow: "hidden" }}>
          ...
          <div className="profile-data-table d-none">
          ...
          <div className="profile-sections">
            ...
            <div className="profile-sectionnew d-none">
              <h2 className="section-title">Rate Information</h2>
              <div className="rate-control-group">
                <div className="rate-control">
                  <label htmlFor="rate-diff">Rate Difference:</label>
                  <div className="rate-input-group">
                    <select id="rate-diff" className="rate-select">
                    ...
                    <button className="buttonnew">Update</button>
                  </div>
                </div>
              </div>
            </div>

            <div className="profile-sectionnew">
              ...
              <div className="info-grid">
                ...
                <div className="info-row">
                  ...
                  <span className="info-value">{balance?.exposer && "-"}</span>
                </div>
              </div>
            </div>
          </div>
